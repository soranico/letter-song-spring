	...
	protected <T> void writeWithMessageConverters(@Nullable T value, MethodParameter returnType,
		...
		if (selectedMediaType != null) {
			...
			for (HttpMessageConverter<?> converter : this.messageConverters) {
				...
				/**
				 * 当前解析器可以支持写出
				 * @see org.springframework.http.converter.json.AbstractJackson2HttpMessageConverter#canWrite(MediaType)
				 */
				if (genericConverter != null ?
					...
					if (body != null) {
						...
						/**
						 * 写出消息
						 * @see org.springframework.http.converter.json.AbstractJackson2HttpMessageConverter#write(Object, MediaType, HttpOutputMessage)
						 */
						if (genericConverter != null) {
